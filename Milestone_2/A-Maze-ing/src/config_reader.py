"""Configuration reader and validator for maze generation.

Provides Pydantic-backed parsing and validation for KEY=VALUE maze
configuration files, ensuring type safety and valid grid boundaries.
"""
...
class MazeConfig(BaseModel):
    ...
    WIDTH: int = Field(ge=3, le=50)
    HEIGHT: int = Field(ge=3, le=50)
    ...
    PERFECT: bool = True
    SEED: typing.Optional[int] = Field(
